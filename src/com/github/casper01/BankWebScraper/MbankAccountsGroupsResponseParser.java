...
class MbankAccountsGroupsResponseParser extends MbankJsonResponseParser {
    private static final String ACCOUNTS_GROUP_KEY = "accountsGroup";
    ...
    MbankAccountsGroupsResponseParser(Connection.Response response) throws InvalidObjectException {
        super(response);
    }

    Collection<BankAccount> getAllAccounts() throws InvalidObjectException {
        JSONArray accountsGroups = (JSONArray) response.get(ACCOUNTS_GROUP_KEY);
